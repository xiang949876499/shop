...
type GoodsServer struct {
	protobuf.UnimplementedGoodsServer
}

func ModelToResponse(goods model.Goods) protobuf.GoodsInfoResponse {
	return protobuf.GoodsInfoResponse{
		Id:              goods.ID,
		...
		Images:          goods.Images,
		Category: &protobuf.CategoryBriefInfoResponse{
...
func (s *GoodsServer) GoodsList(ctx context.Context, req *protobuf.GoodsFilterRequest) (*protobuf.GoodsListResponse, error) {

	//关键词搜索、查询新品、查询热门商品、通过价格区间筛选， 通过商品分类筛选
	goodsListResponse := &protobuf.GoodsListResponse{}
...
func (s *GoodsServer) BatchGetGoods(ctx context.Context, req *protobuf.BatchGoodsIdInfo) (*protobuf.GoodsListResponse, error) {
	goodsListResponse := &protobuf.GoodsListResponse{}
	var goods []model.Goods
...
func (s *GoodsServer) GetGoodsDetail(ctx context.Context, req *protobuf.GoodInfoRequest) (*protobuf.GoodsInfoResponse, error) {
	var goods model.Goods
...
func (s *GoodsServer) CreateGoods(ctx context.Context, req *protobuf.CreateGoodsInfo) (*protobuf.GoodsInfoResponse, error) {
	var category model.Category
...
func (s *GoodsServer) DeleteGoods(ctx context.Context, req *protobuf.DeleteGoodsInfo) (*emptypb.Empty, error) {
...
func (s *GoodsServer) UpdateGoods(ctx context.Context, req *protobuf.CreateGoodsInfo) (*emptypb.Empty, error) {
	var goods model.Goods
